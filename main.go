...
const (
	vmOptionsFile = "phpstorm64.exe.vmoptions"
)
...
func init() {
	...
	// Init app
	if app, err = portapps.New("phpStorm-portable", "phpStorm"); err != nil {
		log.Fatal().Err(err).Msg("Cannot initialize application. See log file for more info.")
	}
}

func main() {
	ideaExe := "phpstorm64.exe"
	ideaVmOptionsFile := "phpstorm64.exe.vmoptions"
	...
	os.Setenv("PHPSTORM_PROPERTIES", ideaPropPath)

	// https://www.jetbrains.com/help/idea/tuning-the-ide.html#configure-jvm-options
	os.Setenv("PHPSTORM_VM_OPTIONS", utl.PathJoin(app.DataPath, vmOptionsFile))
